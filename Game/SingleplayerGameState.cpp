...
namespace
{
    ...
    void OnLevelComplete()
    {
        ...
        s_p1->GetTransform()->SetLocalPosition(20.f, 340.f, 0.);
...
void SingleplayerGameState::OnEnter()
{
    ...
    player1->GetTransform()->SetLocalPosition(30.f, 340.f, 0.f);
    ...
    hiScoreLabelGO->GetTransform()->SetLocalPosition(380.f, 30.f, 0.f);
    ...
    hiScoreGO->GetTransform()->SetLocalPosition(380.f, 44.f, 0.f);
    ...
    dae::BindPlayerInputs(input, s_p1, physics1, p1State, { dae::InputDevice::Keyboard, 0 });
    dae::BindPlayerInputs(input, s_p1, physics1, p1State, { dae::InputDevice::Controller, 0 });
}

void SingleplayerGameState::OnExit()
{
    dae::GameState::onGameOver = {};
    dae::ClearGameScene();
    s_p1 = nullptr;
